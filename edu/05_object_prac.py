...
# print(3 > 2)  # 3이 2보다 크니까 True 출력
# print(5 == 5)  # 5와 5는 같으니 True 출력
# print(type(3 > 2))
# print(type(5 == 5))
...
# num = 10  # 정수형 변수
# print(type(num))  # num의 자료형 출력 <class 'int'>
# num = 10.0  # 실수 값 재할당
...
# device_temp = 77.7  # 장치의 온도 표현(int)
# check_count = 5  # 확인한 횟수 표현(float)
# device_name = "설비장치A"  # 기계의 이름 표현(str)
# is_normal = True  # 기계의 상태를 표현(bool)
